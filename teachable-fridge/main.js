...
class Main {
  constructor() {
    ...
    this.video.src = "http://192.168.172.97:8080/video"
    this.video.crossOrigin = "anonymous";
    this.video.onload = () => { 
      this.imageWidth = this.video.width;
      this.imageHeight = this.video.height;
      this.videoPlaying = true;
      console.log(this);
    };
    this.video.style.width = DISPLAY_SIZE + "px";
